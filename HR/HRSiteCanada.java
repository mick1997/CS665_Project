...
public class HRSiteCanada extends Department implements HandleTask {
     ...
     * public HRSiteCanada constructor
     * */
    public HRSiteCanada(String departName, String departType, String description, Location location,
     ...
     * print the Canada site of Human Resource information
     * */
    @Override
